...
@router.websocket("")
async def ws_events(websocket: WebSocket, token: str = Query(None)):
    ...
    logger.info("ws_events_connect", user_id=user_id)
    ...
    try:
        ...
        logger.info("ws_events_disconnect", user_id=user_id)
    except Exception as e:
        logger.warning("ws_events_error", user_id=user_id, error=str(e))
    finally:
